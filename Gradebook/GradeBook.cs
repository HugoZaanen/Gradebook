...
namespace Gradebook
{
    class GradeBook
    {
        ...
        {
            //auot-implemented property CourseName get sthe name of course
            Console.WriteLine(
                $"Welcome to the grade book for\b{CourseName}\n");
        }
        ...
        public void ProcessGrades()
        {
            ...
            //call OutputBarChart to display garde distribution chart
            OutputBarChart();
        }
        ...
        public int GetMaximum()
        {
            ...
            return highGrade//return highsest grade
        }
        ...
        public void OutputBarChart()
        {
            ...
            //stores frequency of grades in each ragne og 10 grades
